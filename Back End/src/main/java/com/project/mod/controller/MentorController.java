...
public class MentorController {
    ...
    @GetMapping(path = {"/{mentorName}/{password}"})
    public Mentor findMentor(@PathVariable("mentorName") String mentorName, @PathVariable("password") String password) {
    	return mentorService.findMentor(mentorName, password);
    }
}
